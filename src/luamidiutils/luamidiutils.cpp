...
static luaL_Reg luamidiutils_table[] = {{"readfile", midifileutils_readFile},
...
static luaL_Reg MidiStream_metatable[] = {{"play", MidiStream_play},
                                          {NULL, NULL}};
...
static luaL_Reg LuaEventProducer_metatablesender[] = {
    {"pushmessage", LuaEventProducer_pushMessage}, {NULL, NULL}};
...
LUAMIDIUTILS_EXPORT int luaopen_luamidiutils(lua_State* L) {
  ...
  luaW_register<MidiFileEventProducer>(L, "MidiFileEventProducer", NULL, NULL,
                                       MidiFileEventProducer_ctor);
  luaW_extend<MidiFileEventProducer, EventProducer>(L);
  lua_setfield(L, -2, "MidiFileEventProducer");

  luaW_register<MidiStream>(L, "MidiStream", NULL, MidiStream_metatable,
                            MidiStream_ctor);
  lua_setfield(L, -2, "MidiStream");

  luaW_register<LuaEventProducer>(L, "MidiStream", NULL,
                                  LuaEventProducer_metatablesender,
                                  LuaEventProducer_ctor);
